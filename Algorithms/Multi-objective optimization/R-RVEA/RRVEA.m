    ...
    methods
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(A2)
                ...
                A1Obj = A1.objs;
                for i = 1 : Problem.M
%                     dmodel = rbf_build(A1Dec,A1Obj(:,i),'MQ');
                    dmodel = prs2_train(A1Dec,A1Obj(:,i));
...
%                             PopObj(i,j) = rbf_predict(Model{j},A1Dec,PopDec(i,:));
                              PopObj(i,j) = prs2_predict(PopDec(i,:),Model{j});
                        end
                    end
