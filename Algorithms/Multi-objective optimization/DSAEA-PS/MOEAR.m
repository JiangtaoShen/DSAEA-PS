function [PopObj_1,PopObj_2, PopObj_3, PopDec_1, PopDec_2, PopDec_3] = MOEAR(PopDec_1,PopDec_2,PopDec_3,Problem,wmax,RModel,V,A1Dec)
w1      = 1;
w2      = 1;
w3      = 1;
% IBEA
while w1 <= wmax
    ...
    for i = 1: N
        for j = 1 : Problem.M
            PopObj_1(i,j) = rbf_predict(RModel{j},A1Dec,PopDec_1(i,:));
        end
    end
...
while w2 <= wmax
    ...
    for i = 1: N
        for j = 1 : Problem.M
            PopObj_2(i,j) = rbf_predict(RModel{j},A1Dec,PopDec_2(i,:));
        end
    end
...
while w3 <= wmax
    ...
    for i = 1: N
        for j = 1 : Problem.M
            PopObj_3(i,j) = rbf_predict(RModel{j},A1Dec,PopDec_3(i,:));
        end
    end
