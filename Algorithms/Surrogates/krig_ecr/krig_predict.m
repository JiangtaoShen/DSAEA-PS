function [yhat,predstd] = krig_predict(x,srgtSRGT)
...
%
%     [YHAT PREDST] = srgtsKRGPredictor(X, SURROGATE): returns both the
%     predicted response YHAT and the prediction RMSE PREDSTD of the
